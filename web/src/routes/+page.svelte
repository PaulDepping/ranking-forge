  ...
  const features = [
    {
      ...
      description:
        "Fetch your tournament history automatically — just provide the player slugs.",
    },
    {
...
<section class="py-20 text-center">
  ...
  <p class="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
    Pull your tournament data from start.gg, curate which events count, and get
    the stats to back up your ranking decisions.
  </p>
