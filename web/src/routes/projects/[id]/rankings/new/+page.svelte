...
<div class="container mx-auto max-w-md py-8 px-4">
  ...
  <form method="POST" class="flex flex-col gap-4">
    ...
    <div class="flex flex-col gap-2">
      ...
      <RadioGroup.Root bind:value={algorithm} name="algorithm" class="gap-2">
        <!-- Manual card -->
        <Label
          for="alg-manual"
        ...
        >
          <RadioGroup.Item value="" id="alg-manual" class="mt-0.5 shrink-0" />
          <div>
        ...
        <Label
          ...
          class="flex cursor-pointer items-start gap-3 rounded-md border p-3 transition-colors
            ...
            : 'border-border hover:bg-muted/20'}"
        >
          <RadioGroup.Item value="elo" id="alg-elo" class="mt-0.5 shrink-0" />
          <div class="w-full">
            ...
            <div class="text-xs text-muted-foreground">
              Classic rating system — players gain or lose points based on
              results relative to opponent strength
            </div>
            {#if algorithm === "elo"}
              ...
              <div class="mt-3 flex flex-col gap-3 border-t pt-3">
                ...
                <div class="flex items-center justify-between gap-4">
                  <div>
                    ...
                    <div class="text-xs text-muted-foreground">
                      Rating deviation for a new player. Shrinks as they play
                      more sets.
                    </div>
                  </div>
                  <Input
