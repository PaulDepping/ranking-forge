  ...
  <Dialog.Content class="max-w-sm">
    {#if set}
      ...
      <div class="space-y-4 py-2 text-sm">
        ...
        <div>
          <p
            class="mb-1 border-b pb-1 text-xs uppercase tracking-wide text-muted-foreground"
          >
            Match
          </p>
          ...
          <div>
            ...
            <div class="grid grid-cols-2 gap-x-4 gap-y-3">
              <div>
                ...
                >
                  {isWin
                    ? set.winner_placement !== null
                      ? toOrdinal(set.winner_placement)
                      : "?"
                    : set.loser_placement !== null
                      ? toOrdinal(set.loser_placement)
                      : "?"}
                </p>
              </div>
              <div>
      ...
      <div class="flex gap-4 border-t pt-3 text-sm">
        <a
          ...
          class="text-primary hover:underline">↗ View set on start.gg</a
        >
        {#if set.vod_url}
          <a
            href={set.vod_url}
            target="_blank"
            rel="noopener noreferrer"
            class="text-primary hover:underline">▶ Watch VOD</a
          >
        {/if}
      </div>
    {/if}
